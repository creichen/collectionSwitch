...
public class ArrayListActiveFullMonitor<E> implements List<E>, ArrayListInterface<E> {
        private ArrayListInterface<E> coll;
        private ListMetrics state;

        public ArrayListActiveFullMonitor(ArrayListInterface<E> coll, ListMetrics metrics) {
                super();
                this.coll = coll;
                this.state = metrics;
