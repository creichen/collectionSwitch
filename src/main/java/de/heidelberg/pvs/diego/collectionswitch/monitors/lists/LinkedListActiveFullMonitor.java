...
public class LinkedListActiveFullMonitor<E> implements List<E>, LinkedListInterface<E> {
        private LinkedListInterface<E> coll;
        private ListMetrics state;

        public LinkedListActiveFullMonitor(LinkedListInterface<E> coll, ListMetrics metrics) {
                super();
                this.coll = coll;
                this.state = metrics;
