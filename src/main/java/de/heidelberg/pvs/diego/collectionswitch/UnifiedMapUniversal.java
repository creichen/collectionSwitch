...
public class UnifiedMapUniversal<K, V> extends UnifiedMap<K, V> implements HashMapInterface<K, V>, TreeMapInterface<K, V>, LinkedHashMapInterface<K, V> {
    ...
    public UnifiedMapUniversal(Map<? extends K,? extends V> m) {
        super(m);
    }

    public UnifiedMapUniversal(int initialCapacity) {
        // HM, LHM
        super(initialCapacity);
    }

    public UnifiedMapUniversal(int initialCapacity, float loadFactor) {
        // HM, LHM
        super(initialCapacity, loadFactor);
    }

    public UnifiedMapUniversal(int initialCapacity, float loadFactor, boolean accessOrder) {
        // LHM
        super(initialCapacity, loadFactor);
    }

    public UnifiedMapUniversal(Comparator<? super K> comparator) {
        // TM, CSLM
        super();
    }

    public UnifiedMapUniversal(SortedMap<K,? extends V> m) {
        // TM, CSLM
        super(m);
    }
