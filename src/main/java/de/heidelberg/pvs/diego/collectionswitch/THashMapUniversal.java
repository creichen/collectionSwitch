...
public class THashMapUniversal<K, V> extends THashMap<K, V> implements HashMapInterface<K, V>, TreeMapInterface<K, V>, LinkedHashMapInterface<K, V>, ConcurrentSkipListMapInterface<K, V> {
    ...
    public THashMapUniversal(Map<? extends K,? extends V> m) {
        super(m);
    }

    public THashMapUniversal(int initialCapacity) {
        // HM, LHM
        super(initialCapacity);
    }

    public THashMapUniversal(int initialCapacity, float loadFactor) {
        // HM, LHM
        super(initialCapacity, loadFactor);
    }

    public THashMapUniversal(int initialCapacity, float loadFactor, boolean accessOrder) {
        // LHM
        super(initialCapacity, loadFactor);
    }

    public THashMapUniversal(Comparator<? super K> comparator) {
        // TM, CSLM
        super();
    }

    public THashMapUniversal(SortedMap<K,? extends V> m) {
        // TM, CSLM
        super(m);
    }
    ...
    public java.util.NavigableSet<K> keySet() {
        return THashMapUniversal.navigableSet(super.keySet());
    }
