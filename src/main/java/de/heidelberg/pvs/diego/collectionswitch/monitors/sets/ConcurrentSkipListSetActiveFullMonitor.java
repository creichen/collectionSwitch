...
public class ConcurrentSkipListSetActiveFullMonitor<E> implements Set<E>, ConcurrentSkipListSetInterface<E> {
    private ConcurrentSkipListSetInterface<E> coll;
    private SetMetrics state;

    public ConcurrentSkipListSetActiveFullMonitor(ConcurrentSkipListSetInterface<E> coll, SetMetrics metrics) {
        super();
        this.coll = coll;
        this.state = metrics;
