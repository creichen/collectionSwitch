...
public class TreeMapActiveFullMonitor<K, V> implements Map<K, V>, TreeMapInterface<K, V> {
        private TreeMapInterface<K, V> coll;
        private MapMetrics state;

        public TreeMapActiveFullMonitor(TreeMapInterface<K, V> coll, MapMetrics metrics) {
                super();
                this.coll = coll;
                this.state = metrics;
