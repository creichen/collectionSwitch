...
public class TreeSetActiveFullMonitor<E> implements Set<E>, TreeSetInterface<E> {
    private TreeSetInterface<E> coll;
    private SetMetrics state;

    public TreeSetActiveFullMonitor(TreeSetInterface<E> coll, SetMetrics metrics) {
        super();
        this.coll = coll;
        this.state = metrics;
