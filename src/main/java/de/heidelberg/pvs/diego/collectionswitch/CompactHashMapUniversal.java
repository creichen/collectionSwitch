...
public class CompactHashMapUniversal<K, V> extends CompactHashMap<K, V> implements HashMapInterface<K, V>, TreeMapInterface<K, V>, LinkedHashMapInterface<K, V>, ConcurrentSkipListMapInterface<K, V> {
    public CompactHashMapUniversal() {
        super();
    }

    public CompactHashMapUniversal(Map<? extends K,? extends V> m) {
        super();
        putAll(m);
    }

    public CompactHashMapUniversal(int initialCapacity) {
        // HM, LHM
        super();
    }

    public CompactHashMapUniversal(int initialCapacity, float loadFactor) {
        // HM, LHM
        super();
    }

    public CompactHashMapUniversal(int initialCapacity, float loadFactor, boolean accessOrder) {
        // LHM
        super();
    }

    public CompactHashMapUniversal(Comparator<? super K> comparator) {
        // TM, CSLM
        super();
    }

    public CompactHashMapUniversal(SortedMap<K,? extends V> m) {
        // TM, CSLM
        super();
        putAll(m);
    }
    ...
    public java.util.NavigableSet<K> keySet() {
        return CompactHashMapUniversal.navigableSet(super.keySet());
    }
