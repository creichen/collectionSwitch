package de.heidelberg.pvs.diego.collectionswitch.nlp;
...
public class ArrayMapUniversal<K, V> extends ArrayMap<K, V> implements HashMapInterface<K, V>, TreeMapInterface<K, V>, LinkedHashMapInterface<K, V>, ConcurrentSkipListMapInterface<K, V> {
    ...
    public ArrayMapUniversal(Map<? extends K,? extends V> m) {
        super(m);
    }

    public ArrayMapUniversal(int initialCapacity) {
        // HM, LHM
        super(initialCapacity);
    }

    public ArrayMapUniversal(int initialCapacity, float loadFactor) {
        // HM, LHM
        super(initialCapacity);
    }

    public ArrayMapUniversal(int initialCapacity, float loadFactor, boolean accessOrder) {
        // LHM
        super(initialCapacity);
    }

    public ArrayMapUniversal(Comparator<? super K> comparator) {
        // TM, CSLM
        super();
    }

    public ArrayMapUniversal(SortedMap<K,? extends V> m) {
        // TM, CSLM
        super(m);
    }
