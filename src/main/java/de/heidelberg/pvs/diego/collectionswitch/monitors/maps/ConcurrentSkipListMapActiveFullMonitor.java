...
public class ConcurrentSkipListMapActiveFullMonitor<K, V> implements Map<K, V>, ConcurrentSkipListMapInterface<K, V> {
        private ConcurrentSkipListMapInterface<K, V> coll;
        private MapMetrics state;

        public ConcurrentSkipListMapActiveFullMonitor(ConcurrentSkipListMapInterface<K, V> coll, MapMetrics metrics) {
                super();
                this.coll = coll;
                this.state = metrics;
    ...
    public ConcurrentNavigableMap<K, V> headMap(K __sm_arg_0, boolean __sm_arg_1) {
        throw new UnsupportedOperationException();
    }
    ...
    public ConcurrentNavigableMap<K, V> subMap(K __sm_arg_0, boolean __sm_arg_1, K __sm_arg_2, boolean __sm_arg_3) {
        throw new UnsupportedOperationException();
    }
    ...
    public ConcurrentNavigableMap<K, V> tailMap(K __sm_arg_0, boolean __sm_arg_1) {
        throw new UnsupportedOperationException();
    }
