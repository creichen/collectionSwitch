...
public class HashArrayListUniversal<E> extends HashArrayList<E> implements LinkedListInterface<E>, ArrayListInterface<E>, VectorInterface<E> {
    public HashArrayListUniversal() {
        super();
    }

    public HashArrayListUniversal(Collection<? extends E> coll) {
        super(coll);
    }

    public HashArrayListUniversal(int initial_capacity) {
        // ArrayList, Vector
        super(initial_capacity);
    }

    public HashArrayListUniversal(int initial_capacity, int increment) {
        // Vector
        super(initial_capacity);
    }
